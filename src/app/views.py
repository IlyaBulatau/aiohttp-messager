...
from src.utils.queries import insert_chat_in_chats_table, get_chats_in_db, get_chat_by_id
...
async def index(request: web.Request) -> web.Response:
    ...
    if method == 'GET':
        ...
        chats: list[tuple(str, str)] = [(dict(r).get('name'), str((dict(r).get('chat_id')))) for r in res]
        ...
        async with db.transaction():
            await db.executemany(command=insert_chat_in_chats_table, args=[(chat_name.strip(),),])
